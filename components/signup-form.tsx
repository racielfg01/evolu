          ...
          <form action={handleSignUp}>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <Button type="submit" className=" bg-sage-600 hover:bg-sage-700 text-white px-5 py-2 rounded-md transition-colors w-full" disabled={isPending}>
                  Crear cuenta
                </Button>
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <Link href="/login" className="underline underline-offset-4">
               <Button className=" bg-sage-500 hover:bg-sage-600 text-white px-5 py-2 rounded-md transition-colors">
                        Entrar
                      </Button>
              </Link>
            </div>

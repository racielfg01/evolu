...
//     switch (status) {
//       case "CONFIRMED":
//         return { variant: "default" as const, icon: <CheckCircle className="h-4 w-4" />, text: "Confirmada" };
//       case "CANCELLED":
//         return { variant: "destructive" as const, icon: <XCircle className="h-4 w-4" />, text: "Cancelada" };
//       case "PENDING":
//         return { variant: "secondary" as const, icon: <AlertCircle className="h-4 w-4" />, text: "Pendiente" };
//       default:

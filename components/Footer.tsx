    ...
    <footer className="bg-sage-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
           ...
           El lugar donde siempre querrás regresar, porque siempre regresas donde fuiste feliz.
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <div className="flex gap-4 ">
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/evoluofficially/?igsh=MWx1MWc0YmY3ZXdlaQ%3D%3D"
                  target="_blank"
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/profile.php?id=61574581454866"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <p className="text-sage-200 mb-4">
              Suscríbete para recibir ofertas especiales y actualizaciones.
            </p>
            <div className="flex">
              <input
                type="email"
        ...
        <div className="border-t border-sage-700 mt-8 pt-8 text-center text-sage-300">
          <p>
            &copy; {new Date().getFullYear()} Evolu Spa. Todos los derechos
            reservados.{" "}
          </p>
          <p>Creado por DreamTeck </p>
        </div>
      </div>
    </footer>
  );
